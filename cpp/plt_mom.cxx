 ...
 // gStyle->SetOptStat(0);
  ...
  TCut cut11 = "mc3_mom_ee_D_starDzstar_antiD0pi_kpi>0";
    ...
    mcsig4.Draw("mc1_mom_ee_antiD0Dzstarpi_kpi>>hall2b",cut4b&&cut1j);
     ...
     hall2a->SetFillColor(33);
     hall2a->SetLineColor(33);
     hall2b->SetFillColor(44);
     hall2b->SetLineColor(44);
  ...
  hall2a->SetLineWidth(2);
  hall2b->SetLineWidth(2);
 // FormatData(EOP);
  ...
  RooDataHist* incmc10 = new RooDataHist("incmc10", "", xreg1, hall2a);
  RooDataHist* incmc11 = new RooDataHist("incmc11", "", xreg1, hall2b);
 ...
 // incmc3->plotOn(xframe1,LineColor(4),LineWidth(1),MarkerColor(4),MarkerSize(0.5));
  ...
  incmc10->plotOn(xframe1,LineColor(33),LineWidth(2),MarkerColor(33),MarkerSize(0.5));
  incmc11->plotOn(xframe1,LineColor(44),LineWidth(2),MarkerColor(44),MarkerSize(0.5));
  ...
  xframe1->SetYTitle("Events/6 MeV/c");
 ...
 // Double_t incmentr3 = (Double_t)hall3->GetEntries();
  ...
  Double_t incmentr10 = (Double_t)hall2a->GetEntries();
  Double_t incmentr11 = (Double_t)hall2b->GetEntries();
   ...
   // TLegend * leg = new TLegend(0.2, 0.35, 0.55, 0.92);
    ...
    leg->AddEntry(hall2a,  "#bar{D^{0}}D^{*0}#pi^{0}", "L");
    leg->AddEntry(hall2b,  "#bar{D^{0}}D^{*+}#pi^{-}", "L");
  //  leg->AddEntry(hall3,  "D0barD*0pi0", "L");
    ...
    leg->AddEntry(hall8,  "D^{*-}D^{+}", "L");
    leg->AddEntry(hall9,  "D^{*-}D^{*+}", "L");
  ...
  cout<<" signal10 = "<<incmentr10<<endl;
  cout<<" signal11 = "<<incmentr11<<endl;

  cout<<" signal = "<<(incmentr1+incmentr2+incmentr4+incmentr5+incmentr6+incmentr7+incmentr8+incmentr9+incmentr10+incmentr11)<<endl;
