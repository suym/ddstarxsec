...
//  TH1::SetDefaultSumw2();
  ...
  TH1D *hall2a= new TH1D("hall2a","",n1bin, x1min, x1max);
  TH1D *hall2b= new TH1D("hall2b","",n1bin, x1min, x1max);
  ...
  TCut cut11 = "mc3_mom_ee_D_starDzstar_antiD0pi_kpi>0"; 
    ...
    Double_t mentr10 = (Double_t)hall2a->GetEntries();
    Double_t mentr11 = (Double_t)hall2b->GetEntries();
    ...
    Double_t mentr = (Double_t)hs9->GetEntries();


   //  FormatData(hs7);
   //  NameAxes(hs7, "P*_{anti-D0} (GeV/c)", "Events/ 2 MeV/c"); 
     hs9->SetXTitle("P*_{#bar{D^{0}}} (Gev/c)");
     hs9->GetXaxis()->CenterTitle(true);
     hs9->SetYTitle("Events/ 6 MeV/c");
     hs9->GetYaxis()->CenterTitle(true);
     hs9->SetFillColor(1);
     hs9->SetLineColor(1);
   ...
   cout<<"signal10 events number  = "<<mentr10<<endl;
   cout<<"signal11 events number  = "<<mentr11<<endl;
   cout<<"bkg events number  = "<<(mentrhall-mentr1-mentr2-mentr4-mentr5-mentr6-mentr7-mentr8-mentr9-mentr10-mentr11)<<endl;
