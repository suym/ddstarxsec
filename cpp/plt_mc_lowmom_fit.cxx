...
void plt_mc_lowmom_fit(){
  ...
  const double x1min= 0.15;
  const double x1max= 0.75;
  const double n1bin= 100;
...
//	RooHistPdf mcsig3_pdf("mcsig3_pdf","mcsig3_pdf",RooArgSet(xreg),mcsig13);
	...
	RooRealVar signal2("signal2","signal2", 6400,  0, 10000);
	...
	RooRealVar signal9("signal9","signal9", 1000,  0, 15000);
        ...
        RooAddPdf sum("sum","all-mcsig+bkg",RooArgList(mcsig5_pdf,mcsig6_pdf,mcsig7_pdf,mcsig9_pdf,bkg_pdf1,mcsig2a_pdf,mcsig2b_pdf),RooArgList(signal5,signal6,signal7,signal9,nbkg_1,signal2a,signal2b));
   ...
   // TLegend * leg = new TLegend(0.35, 0.65, 0.55, 0.85);
    ...
    leg->Draw();
          ...
          cout<<" N_signal = "<<(signal2a.getVal()+signal2b.getVal()+signal5.getVal()+signal6.getVal()+signal7.getVal()+signal9.getVal())<<" +- "<<TMath::Sqrt(signal2a.getError()*signal2a.getError()+signal2b.getError()*signal2b.getError()+signal5.getError()*signal5.getError()+signal6.getError()*signal6.getError()+signal7.getError()*signal7.getError()+signal9.getError()*signal9.getError())<<endl;
          cout<<" N_signal2a = "<<signal2a.getVal()<<" +- "<<signal2a.getError()<<endl;
          cout<<" N_signal2b = "<<signal2b.getVal()<<" +- "<<signal2b.getError()<<endl;
