...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(DDAlg_tag).make$(cmt_lock_pid)
else
#cmt_local_tagfile = $(DDAlg_tag).make
cmt_local_tagfile = $(bin)$(DDAlg_tag).make
endif
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_DDAlgsetup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_DDAlgsetup.make
else
#cmt_local_setup = $(bin)DDAlgsetup$(cmt_lock_pid).make
...
DD_extratags = -tag_add=target_DD

#$(cmt_local_tagfile_DD) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_DD) ::
else
$(cmt_local_tagfile_DD) :
endif
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_DD)"
	@if test -f $(cmt_local_tagfile_DD); then /bin/rm -f $(cmt_local_tagfile_DD); fi ; \
	  $(cmtexe) -tag=$(tags) $(DD_extratags) build tag_makefile >>$(cmt_local_tagfile_DD); \
	  if test -f $(cmt_final_setup_DD); then /bin/rm -f $(cmt_final_setup_DD); fi; \
	  $(cmtexe) -tag=$(tags) $(DD_extratags) show setup >>$(cmt_final_setup_DD)
	$(echo) setup.make ok
...
ifndef QUICK
$(cmt_local_DD_makefile) :: $(DD_dependencies) $(cmt_local_tagfile_DD) build_library_links dirs
else
$(cmt_local_DD_makefile) :: $(cmt_local_tagfile_DD)
endif
	$(echo) "(constituents.make) Building DD.make"; \
	  $(cmtexe) -tag=$(tags) $(DD_extratags) build constituent_makefile -out=$(cmt_local_DD_makefile) DD

DD :: $(DD_dependencies) $(cmt_local_DD_makefile)
	$(echo) "(constituents.make) Starting DD"
	@$(MAKE) -f $(cmt_local_DD_makefile) cmt_lock_pid=$${cmt_lock_pid} DD
	$(echo) "(constituents.make) DD done"

clean :: DDclean

DDclean :: $(DDclean_dependencies) ##$(cmt_local_DD_makefile)
	$(echo) "(constituents.make) Starting DDclean"
	@-if test -f $(cmt_local_DD_makefile); then \
	  $(MAKE) -f $(cmt_local_DD_makefile) cmt_lock_pid=$${cmt_lock_pid} DDclean; \
	fi

##	  /bin/rm -f $(cmt_local_DD_makefile) $(bin)DD_dependencies.make

install :: DDinstall

DDinstall :: $(DD_dependencies) $(cmt_local_DD_makefile)
	$(echo) "(constituents.make) Starting install DD"
	@-$(MAKE) -f $(cmt_local_DD_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install DD done"

uninstall :: DDuninstall

DDuninstall :: $(cmt_local_DD_makefile)
	$(echo) "(constituents.make) Starting uninstall DD"
	@-$(MAKE) -f $(cmt_local_DD_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
	$(echo) "(constituents.make) uninstall DD done"
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(DDAlg_tag)_install_includes.make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_DDAlg_install_includessetup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_includes = $(DDAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(DDAlg_tag)_install_includes.make
cmt_final_setup_install_includes = $(bin)DDAlg_install_includessetup.make
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(DDAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_DDAlgsetup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_includes = $(DDAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(DDAlg_tag).make
cmt_final_setup_install_includes = $(bin)DDAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
endif
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(DDAlg_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_DDAlg_makesetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(DDAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(DDAlg_tag)_make.make
cmt_final_setup_make = $(bin)DDAlg_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(DDAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_DDAlgsetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(DDAlg_tag).make
cmt_local_tagfile_make = $(bin)$(DDAlg_tag).make
cmt_final_setup_make = $(bin)DDAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
endif
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(DDAlg_tag)_CompilePython.make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_DDAlg_CompilePythonsetup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
#cmt_local_tagfile_CompilePython = $(DDAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(DDAlg_tag)_CompilePython.make
cmt_final_setup_CompilePython = $(bin)DDAlg_CompilePythonsetup.make
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(DDAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_DDAlgsetup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
#cmt_local_tagfile_CompilePython = $(DDAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(DDAlg_tag).make
cmt_final_setup_CompilePython = $(bin)DDAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
endif
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(DDAlg_tag)_qmtest_run.make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_DDAlg_qmtest_runsetup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_run = $(DDAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(DDAlg_tag)_qmtest_run.make
cmt_final_setup_qmtest_run = $(bin)DDAlg_qmtest_runsetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(DDAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_DDAlgsetup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_run = $(DDAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(DDAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)DDAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
endif
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(DDAlg_tag)_qmtest_summarize.make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_DDAlg_qmtest_summarizesetup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_summarize = $(DDAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(DDAlg_tag)_qmtest_summarize.make
cmt_final_setup_qmtest_summarize = $(bin)DDAlg_qmtest_summarizesetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(DDAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_DDAlgsetup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_summarize = $(DDAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(DDAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)DDAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
endif
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(DDAlg_tag)_TestPackage.make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_DDAlg_TestPackagesetup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestPackage = $(DDAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(DDAlg_tag)_TestPackage.make
cmt_final_setup_TestPackage = $(bin)DDAlg_TestPackagesetup.make
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(DDAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_DDAlgsetup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestPackage = $(DDAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(DDAlg_tag).make
cmt_final_setup_TestPackage = $(bin)DDAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
endif
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(DDAlg_tag)_TestProject.make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_DDAlg_TestProjectsetup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestProject = $(DDAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(DDAlg_tag)_TestProject.make
cmt_final_setup_TestProject = $(bin)DDAlg_TestProjectsetup.make
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(DDAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_DDAlgsetup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestProject = $(DDAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(DDAlg_tag).make
cmt_final_setup_TestProject = $(bin)DDAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
endif
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(DDAlg_tag)_new_rootsys.make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_DDAlg_new_rootsyssetup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
#cmt_local_tagfile_new_rootsys = $(DDAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(DDAlg_tag)_new_rootsys.make
cmt_final_setup_new_rootsys = $(bin)DDAlg_new_rootsyssetup.make
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(DDAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_DDAlgsetup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
#cmt_local_tagfile_new_rootsys = $(DDAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(DDAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)DDAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
endif
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(DDAlg_tag)_DatabaseSvc_check_install_scripts.make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_DDAlg_DatabaseSvc_check_install_scriptssetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(DDAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(DDAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)DDAlg_DatabaseSvc_check_install_scriptssetup.make
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(DDAlg_tag).make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_DDAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(DDAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(DDAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)DDAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
endif
