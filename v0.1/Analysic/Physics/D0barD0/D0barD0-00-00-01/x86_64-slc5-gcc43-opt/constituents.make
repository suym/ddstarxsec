...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(D0barD0_tag).make$(cmt_lock_pid)
else
#cmt_local_tagfile = $(D0barD0_tag).make
cmt_local_tagfile = $(bin)$(D0barD0_tag).make
endif
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_D0barD0setup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_D0barD0setup.make
else
#cmt_local_setup = $(bin)D0barD0setup$(cmt_lock_pid).make
...
D0barD0_extratags = -tag_add=target_D0barD0

#$(cmt_local_tagfile_D0barD0) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_D0barD0) ::
else
$(cmt_local_tagfile_D0barD0) :
endif
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_D0barD0)"
	@if test -f $(cmt_local_tagfile_D0barD0); then /bin/rm -f $(cmt_local_tagfile_D0barD0); fi ; \
	  $(cmtexe) -tag=$(tags) $(D0barD0_extratags) build tag_makefile >>$(cmt_local_tagfile_D0barD0); \
	  if test -f $(cmt_final_setup_D0barD0); then /bin/rm -f $(cmt_final_setup_D0barD0); fi; \
	  $(cmtexe) -tag=$(tags) $(D0barD0_extratags) show setup >>$(cmt_final_setup_D0barD0)
	$(echo) setup.make ok
...
ifndef QUICK
$(cmt_local_D0barD0_makefile) :: $(D0barD0_dependencies) $(cmt_local_tagfile_D0barD0) build_library_links dirs
else
$(cmt_local_D0barD0_makefile) :: $(cmt_local_tagfile_D0barD0)
endif
	$(echo) "(constituents.make) Building D0barD0.make"; \
	  $(cmtexe) -tag=$(tags) $(D0barD0_extratags) build constituent_makefile -out=$(cmt_local_D0barD0_makefile) D0barD0

D0barD0 :: $(D0barD0_dependencies) $(cmt_local_D0barD0_makefile)
	$(echo) "(constituents.make) Starting D0barD0"
	@$(MAKE) -f $(cmt_local_D0barD0_makefile) cmt_lock_pid=$${cmt_lock_pid} D0barD0
	$(echo) "(constituents.make) D0barD0 done"

clean :: D0barD0clean

D0barD0clean :: $(D0barD0clean_dependencies) ##$(cmt_local_D0barD0_makefile)
	$(echo) "(constituents.make) Starting D0barD0clean"
	@-if test -f $(cmt_local_D0barD0_makefile); then \
	  $(MAKE) -f $(cmt_local_D0barD0_makefile) cmt_lock_pid=$${cmt_lock_pid} D0barD0clean; \
	fi

##	  /bin/rm -f $(cmt_local_D0barD0_makefile) $(bin)D0barD0_dependencies.make

install :: D0barD0install

D0barD0install :: $(D0barD0_dependencies) $(cmt_local_D0barD0_makefile)
	$(echo) "(constituents.make) Starting install D0barD0"
	@-$(MAKE) -f $(cmt_local_D0barD0_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install D0barD0 done"

uninstall :: D0barD0uninstall

D0barD0uninstall :: $(cmt_local_D0barD0_makefile)
	$(echo) "(constituents.make) Starting uninstall D0barD0"
	@-$(MAKE) -f $(cmt_local_D0barD0_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
	$(echo) "(constituents.make) uninstall D0barD0 done"
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(D0barD0_tag)_install_includes.make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_D0barD0_install_includessetup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_includes = $(D0barD0_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(D0barD0_tag)_install_includes.make
cmt_final_setup_install_includes = $(bin)D0barD0_install_includessetup.make
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(D0barD0_tag).make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_D0barD0setup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_includes = $(D0barD0_tag).make
cmt_local_tagfile_install_includes = $(bin)$(D0barD0_tag).make
cmt_final_setup_install_includes = $(bin)D0barD0setup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
endif
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(D0barD0_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_D0barD0_makesetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(D0barD0_tag)_make.make
cmt_local_tagfile_make = $(bin)$(D0barD0_tag)_make.make
cmt_final_setup_make = $(bin)D0barD0_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(D0barD0_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_D0barD0setup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(D0barD0_tag).make
cmt_local_tagfile_make = $(bin)$(D0barD0_tag).make
cmt_final_setup_make = $(bin)D0barD0setup.make
cmt_local_make_makefile = $(bin)make.make
endif
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(D0barD0_tag)_CompilePython.make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_D0barD0_CompilePythonsetup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
#cmt_local_tagfile_CompilePython = $(D0barD0_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(D0barD0_tag)_CompilePython.make
cmt_final_setup_CompilePython = $(bin)D0barD0_CompilePythonsetup.make
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(D0barD0_tag).make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_D0barD0setup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
#cmt_local_tagfile_CompilePython = $(D0barD0_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(D0barD0_tag).make
cmt_final_setup_CompilePython = $(bin)D0barD0setup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
endif
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(D0barD0_tag)_qmtest_run.make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_D0barD0_qmtest_runsetup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_run = $(D0barD0_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(D0barD0_tag)_qmtest_run.make
cmt_final_setup_qmtest_run = $(bin)D0barD0_qmtest_runsetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(D0barD0_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_D0barD0setup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_run = $(D0barD0_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(D0barD0_tag).make
cmt_final_setup_qmtest_run = $(bin)D0barD0setup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
endif
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(D0barD0_tag)_qmtest_summarize.make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_D0barD0_qmtest_summarizesetup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_summarize = $(D0barD0_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(D0barD0_tag)_qmtest_summarize.make
cmt_final_setup_qmtest_summarize = $(bin)D0barD0_qmtest_summarizesetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(D0barD0_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_D0barD0setup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_summarize = $(D0barD0_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(D0barD0_tag).make
cmt_final_setup_qmtest_summarize = $(bin)D0barD0setup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
endif
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(D0barD0_tag)_TestPackage.make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_D0barD0_TestPackagesetup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestPackage = $(D0barD0_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(D0barD0_tag)_TestPackage.make
cmt_final_setup_TestPackage = $(bin)D0barD0_TestPackagesetup.make
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(D0barD0_tag).make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_D0barD0setup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestPackage = $(D0barD0_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(D0barD0_tag).make
cmt_final_setup_TestPackage = $(bin)D0barD0setup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
endif
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(D0barD0_tag)_TestProject.make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_D0barD0_TestProjectsetup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestProject = $(D0barD0_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(D0barD0_tag)_TestProject.make
cmt_final_setup_TestProject = $(bin)D0barD0_TestProjectsetup.make
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(D0barD0_tag).make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_D0barD0setup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestProject = $(D0barD0_tag).make
cmt_local_tagfile_TestProject = $(bin)$(D0barD0_tag).make
cmt_final_setup_TestProject = $(bin)D0barD0setup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
endif
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(D0barD0_tag)_new_rootsys.make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_D0barD0_new_rootsyssetup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
#cmt_local_tagfile_new_rootsys = $(D0barD0_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(D0barD0_tag)_new_rootsys.make
cmt_final_setup_new_rootsys = $(bin)D0barD0_new_rootsyssetup.make
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(D0barD0_tag).make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_D0barD0setup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
#cmt_local_tagfile_new_rootsys = $(D0barD0_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(D0barD0_tag).make
cmt_final_setup_new_rootsys = $(bin)D0barD0setup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
endif
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(D0barD0_tag)_DatabaseSvc_check_install_scripts.make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_D0barD0_DatabaseSvc_check_install_scriptssetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(D0barD0_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(D0barD0_tag)_DatabaseSvc_check_install_scripts.make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)D0barD0_DatabaseSvc_check_install_scriptssetup.make
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(D0barD0_tag).make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_D0barD0setup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(D0barD0_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(D0barD0_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)D0barD0setup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
endif
