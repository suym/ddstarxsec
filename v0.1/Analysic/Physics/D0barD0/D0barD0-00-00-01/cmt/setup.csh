...
${CMTROOT}/mgr/cmt setup -csh -pack=D0barD0 -version=D0barD0-00-00-01 -path=/afs/ihep.ac.cn/users/s/suym/bes/kpi/v0.1/Analysic/Physics  -no_cleanup $* >${tempfile}; source ${tempfile}
/bin/rm -f ${tempfile}
