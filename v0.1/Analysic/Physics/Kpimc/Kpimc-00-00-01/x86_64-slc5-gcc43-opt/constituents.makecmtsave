...
ifdef READONLY
cmt_local_tagfile = /tmp/CMT_$(Kpimc_tag).make$(cmt_lock_pid)
else
#cmt_local_tagfile = $(Kpimc_tag).make
cmt_local_tagfile = $(bin)$(Kpimc_tag).make
endif
...
ifdef READONLY
cmt_local_setup = /tmp/CMT_Kpimcsetup$(cmt_lock_pid).make
cmt_final_setup = /tmp/CMT_Kpimcsetup.make
else
#cmt_local_setup = $(bin)Kpimcsetup$(cmt_lock_pid).make
...
Kpimc_extratags = -tag_add=target_Kpimc

#$(cmt_local_tagfile_Kpimc) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_Kpimc) ::
else
$(cmt_local_tagfile_Kpimc) :
endif
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_Kpimc)"
	@if test -f $(cmt_local_tagfile_Kpimc); then /bin/rm -f $(cmt_local_tagfile_Kpimc); fi ; \
	  $(cmtexe) -tag=$(tags) $(Kpimc_extratags) build tag_makefile >>$(cmt_local_tagfile_Kpimc); \
	  if test -f $(cmt_final_setup_Kpimc); then /bin/rm -f $(cmt_final_setup_Kpimc); fi; \
	  $(cmtexe) -tag=$(tags) $(Kpimc_extratags) show setup >>$(cmt_final_setup_Kpimc)
	$(echo) setup.make ok
...
ifndef QUICK
$(cmt_local_Kpimc_makefile) :: $(Kpimc_dependencies) $(cmt_local_tagfile_Kpimc) build_library_links dirs
else
$(cmt_local_Kpimc_makefile) :: $(cmt_local_tagfile_Kpimc)
endif
	$(echo) "(constituents.make) Building Kpimc.make"; \
	  $(cmtexe) -tag=$(tags) $(Kpimc_extratags) build constituent_makefile -out=$(cmt_local_Kpimc_makefile) Kpimc

Kpimc :: $(Kpimc_dependencies) $(cmt_local_Kpimc_makefile)
	$(echo) "(constituents.make) Starting Kpimc"
	@$(MAKE) -f $(cmt_local_Kpimc_makefile) cmt_lock_pid=$${cmt_lock_pid} Kpimc
	$(echo) "(constituents.make) Kpimc done"

clean :: Kpimcclean

Kpimcclean :: $(Kpimcclean_dependencies) ##$(cmt_local_Kpimc_makefile)
	$(echo) "(constituents.make) Starting Kpimcclean"
	@-if test -f $(cmt_local_Kpimc_makefile); then \
	  $(MAKE) -f $(cmt_local_Kpimc_makefile) cmt_lock_pid=$${cmt_lock_pid} Kpimcclean; \
	fi

##	  /bin/rm -f $(cmt_local_Kpimc_makefile) $(bin)Kpimc_dependencies.make

install :: Kpimcinstall

Kpimcinstall :: $(Kpimc_dependencies) $(cmt_local_Kpimc_makefile)
	$(echo) "(constituents.make) Starting install Kpimc"
	@-$(MAKE) -f $(cmt_local_Kpimc_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install Kpimc done"

uninstall :: Kpimcuninstall

Kpimcuninstall :: $(cmt_local_Kpimc_makefile)
	$(echo) "(constituents.make) Starting uninstall Kpimc"
	@-$(MAKE) -f $(cmt_local_Kpimc_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
	$(echo) "(constituents.make) uninstall Kpimc done"
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(Kpimc_tag)_install_includes.make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_Kpimc_install_includessetup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_includes = $(Kpimc_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(Kpimc_tag)_install_includes.make
cmt_final_setup_install_includes = $(bin)Kpimc_install_includessetup.make
...
ifdef READONLY
cmt_local_tagfile_install_includes = /tmp/CMT_$(Kpimc_tag).make$(cmt_lock_pid)
cmt_final_setup_install_includes = /tmp/CMT_Kpimcsetup.make
cmt_local_install_includes_makefile = /tmp/CMT_install_includes$(cmt_lock_pid).make
else
#cmt_local_tagfile_install_includes = $(Kpimc_tag).make
cmt_local_tagfile_install_includes = $(bin)$(Kpimc_tag).make
cmt_final_setup_install_includes = $(bin)Kpimcsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
endif
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(Kpimc_tag)_make.make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_Kpimc_makesetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(Kpimc_tag)_make.make
cmt_local_tagfile_make = $(bin)$(Kpimc_tag)_make.make
cmt_final_setup_make = $(bin)Kpimc_makesetup.make
...
ifdef READONLY
cmt_local_tagfile_make = /tmp/CMT_$(Kpimc_tag).make$(cmt_lock_pid)
cmt_final_setup_make = /tmp/CMT_Kpimcsetup.make
cmt_local_make_makefile = /tmp/CMT_make$(cmt_lock_pid).make
else
#cmt_local_tagfile_make = $(Kpimc_tag).make
cmt_local_tagfile_make = $(bin)$(Kpimc_tag).make
cmt_final_setup_make = $(bin)Kpimcsetup.make
cmt_local_make_makefile = $(bin)make.make
endif
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(Kpimc_tag)_CompilePython.make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_Kpimc_CompilePythonsetup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
#cmt_local_tagfile_CompilePython = $(Kpimc_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(Kpimc_tag)_CompilePython.make
cmt_final_setup_CompilePython = $(bin)Kpimc_CompilePythonsetup.make
...
ifdef READONLY
cmt_local_tagfile_CompilePython = /tmp/CMT_$(Kpimc_tag).make$(cmt_lock_pid)
cmt_final_setup_CompilePython = /tmp/CMT_Kpimcsetup.make
cmt_local_CompilePython_makefile = /tmp/CMT_CompilePython$(cmt_lock_pid).make
else
#cmt_local_tagfile_CompilePython = $(Kpimc_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(Kpimc_tag).make
cmt_final_setup_CompilePython = $(bin)Kpimcsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
endif
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(Kpimc_tag)_qmtest_run.make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_Kpimc_qmtest_runsetup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_run = $(Kpimc_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(Kpimc_tag)_qmtest_run.make
cmt_final_setup_qmtest_run = $(bin)Kpimc_qmtest_runsetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_run = /tmp/CMT_$(Kpimc_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_run = /tmp/CMT_Kpimcsetup.make
cmt_local_qmtest_run_makefile = /tmp/CMT_qmtest_run$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_run = $(Kpimc_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(Kpimc_tag).make
cmt_final_setup_qmtest_run = $(bin)Kpimcsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
endif
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(Kpimc_tag)_qmtest_summarize.make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_Kpimc_qmtest_summarizesetup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_summarize = $(Kpimc_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Kpimc_tag)_qmtest_summarize.make
cmt_final_setup_qmtest_summarize = $(bin)Kpimc_qmtest_summarizesetup.make
...
ifdef READONLY
cmt_local_tagfile_qmtest_summarize = /tmp/CMT_$(Kpimc_tag).make$(cmt_lock_pid)
cmt_final_setup_qmtest_summarize = /tmp/CMT_Kpimcsetup.make
cmt_local_qmtest_summarize_makefile = /tmp/CMT_qmtest_summarize$(cmt_lock_pid).make
else
#cmt_local_tagfile_qmtest_summarize = $(Kpimc_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(Kpimc_tag).make
cmt_final_setup_qmtest_summarize = $(bin)Kpimcsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
endif
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(Kpimc_tag)_TestPackage.make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_Kpimc_TestPackagesetup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestPackage = $(Kpimc_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(Kpimc_tag)_TestPackage.make
cmt_final_setup_TestPackage = $(bin)Kpimc_TestPackagesetup.make
...
ifdef READONLY
cmt_local_tagfile_TestPackage = /tmp/CMT_$(Kpimc_tag).make$(cmt_lock_pid)
cmt_final_setup_TestPackage = /tmp/CMT_Kpimcsetup.make
cmt_local_TestPackage_makefile = /tmp/CMT_TestPackage$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestPackage = $(Kpimc_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(Kpimc_tag).make
cmt_final_setup_TestPackage = $(bin)Kpimcsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
endif
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(Kpimc_tag)_TestProject.make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_Kpimc_TestProjectsetup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestProject = $(Kpimc_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(Kpimc_tag)_TestProject.make
cmt_final_setup_TestProject = $(bin)Kpimc_TestProjectsetup.make
...
ifdef READONLY
cmt_local_tagfile_TestProject = /tmp/CMT_$(Kpimc_tag).make$(cmt_lock_pid)
cmt_final_setup_TestProject = /tmp/CMT_Kpimcsetup.make
cmt_local_TestProject_makefile = /tmp/CMT_TestProject$(cmt_lock_pid).make
else
#cmt_local_tagfile_TestProject = $(Kpimc_tag).make
cmt_local_tagfile_TestProject = $(bin)$(Kpimc_tag).make
cmt_final_setup_TestProject = $(bin)Kpimcsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
endif
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(Kpimc_tag)_new_rootsys.make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_Kpimc_new_rootsyssetup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
#cmt_local_tagfile_new_rootsys = $(Kpimc_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(Kpimc_tag)_new_rootsys.make
cmt_final_setup_new_rootsys = $(bin)Kpimc_new_rootsyssetup.make
...
ifdef READONLY
cmt_local_tagfile_new_rootsys = /tmp/CMT_$(Kpimc_tag).make$(cmt_lock_pid)
cmt_final_setup_new_rootsys = /tmp/CMT_Kpimcsetup.make
cmt_local_new_rootsys_makefile = /tmp/CMT_new_rootsys$(cmt_lock_pid).make
else
#cmt_local_tagfile_new_rootsys = $(Kpimc_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(Kpimc_tag).make
cmt_final_setup_new_rootsys = $(bin)Kpimcsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
endif
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(Kpimc_tag)_DatabaseSvc_check_install_scripts.make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_Kpimc_DatabaseSvc_check_install_scriptssetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Kpimc_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Kpimc_tag)_DatabaseSvc_check_install_scripts.make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Kpimc_DatabaseSvc_check_install_scriptssetup.make
...
ifdef READONLY
cmt_local_tagfile_DatabaseSvc_check_install_scripts = /tmp/CMT_$(Kpimc_tag).make$(cmt_lock_pid)
cmt_final_setup_DatabaseSvc_check_install_scripts = /tmp/CMT_Kpimcsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = /tmp/CMT_DatabaseSvc_check_install_scripts$(cmt_lock_pid).make
else
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(Kpimc_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(Kpimc_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)Kpimcsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
endif
