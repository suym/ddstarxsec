...
${CMTROOT}/mgr/cmt setup -sh -pack=Kpimc -version=Kpimc-00-00-01 -path=/afs/ihep.ac.cn/users/s/suym/bes/kpi/d0bard0/Analysic/Physics  -no_cleanup $* >${tempfile}; . ${tempfile}
/bin/rm -f ${tempfile}
