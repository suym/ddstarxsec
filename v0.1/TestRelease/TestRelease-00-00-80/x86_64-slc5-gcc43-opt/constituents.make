...
cmt_Ekhara_check_install_runtime_has_target_tag = 1

#--------------------------------------------------------

ifdef cmt_Ekhara_check_install_runtime_has_target_tag

ifdef READONLY
cmt_local_tagfile_Ekhara_check_install_runtime = /tmp/CMT_$(TestRelease_tag)_Ekhara_check_install_runtime.make$(cmt_lock_pid)
cmt_final_setup_Ekhara_check_install_runtime = /tmp/CMT_TestRelease_Ekhara_check_install_runtimesetup.make
cmt_local_Ekhara_check_install_runtime_makefile = /tmp/CMT_Ekhara_check_install_runtime$(cmt_lock_pid).make
else
#cmt_local_tagfile_Ekhara_check_install_runtime = $(TestRelease_tag)_Ekhara_check_install_runtime.make
cmt_local_tagfile_Ekhara_check_install_runtime = $(bin)$(TestRelease_tag)_Ekhara_check_install_runtime.make
cmt_final_setup_Ekhara_check_install_runtime = $(bin)TestRelease_Ekhara_check_install_runtimesetup.make
cmt_local_Ekhara_check_install_runtime_makefile = $(bin)Ekhara_check_install_runtime.make
endif

Ekhara_check_install_runtime_extratags = -tag_add=target_Ekhara_check_install_runtime

#$(cmt_local_tagfile_Ekhara_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_Ekhara_check_install_runtime) ::
else
$(cmt_local_tagfile_Ekhara_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding setup.make $(cmt_local_tagfile_Ekhara_check_install_runtime)"
	@if test -f $(cmt_local_tagfile_Ekhara_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_Ekhara_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(Ekhara_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_Ekhara_check_install_runtime); \
	  if test -f $(cmt_final_setup_Ekhara_check_install_runtime); then /bin/rm -f $(cmt_final_setup_Ekhara_check_install_runtime); fi; \
	  $(cmtexe) -tag=$(tags) $(Ekhara_check_install_runtime_extratags) show setup >>$(cmt_final_setup_Ekhara_check_install_runtime)
	$(echo) setup.make ok

else

ifdef READONLY
cmt_local_tagfile_Ekhara_check_install_runtime = /tmp/CMT_$(TestRelease_tag).make$(cmt_lock_pid)
cmt_final_setup_Ekhara_check_install_runtime = /tmp/CMT_TestReleasesetup.make
cmt_local_Ekhara_check_install_runtime_makefile = /tmp/CMT_Ekhara_check_install_runtime$(cmt_lock_pid).make
else
#cmt_local_tagfile_Ekhara_check_install_runtime = $(TestRelease_tag).make
cmt_local_tagfile_Ekhara_check_install_runtime = $(bin)$(TestRelease_tag).make
cmt_final_setup_Ekhara_check_install_runtime = $(bin)TestReleasesetup.make
cmt_local_Ekhara_check_install_runtime_makefile = $(bin)Ekhara_check_install_runtime.make
endif
...
ifndef QUICK
$(cmt_local_Ekhara_check_install_runtime_makefile) :: $(Ekhara_check_install_runtime_dependencies) $(cmt_local_tagfile_Ekhara_check_install_runtime) build_library_links dirs
else
$(cmt_local_Ekhara_check_install_runtime_makefile) :: $(cmt_local_tagfile_Ekhara_check_install_runtime)
endif
	$(echo) "(constituents.make) Building Ekhara_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(Ekhara_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_Ekhara_check_install_runtime_makefile) Ekhara_check_install_runtime

Ekhara_check_install_runtime :: $(Ekhara_check_install_runtime_dependencies) $(cmt_local_Ekhara_check_install_runtime_makefile)
	$(echo) "(constituents.make) Creating Ekhara_check_install_runtime${lock_suffix} and Starting Ekhara_check_install_runtime"
	@${lock_command} Ekhara_check_install_runtime${lock_suffix} || exit $$?; \
	  retval=$$?; \
	  trap '${unlock_command} Ekhara_check_install_runtime${lock_suffix}; exit $${retval}' 1 2 15; \
	  $(MAKE) -f $(cmt_local_Ekhara_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} Ekhara_check_install_runtime; \
	  retval=$$?; ${unlock_command} Ekhara_check_install_runtime${lock_suffix}; exit $${retval}
	$(echo) "(constituents.make) Ekhara_check_install_runtime done"

clean :: Ekhara_check_install_runtimeclean

Ekhara_check_install_runtimeclean :: $(Ekhara_check_install_runtimeclean_dependencies) ##$(cmt_local_Ekhara_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting Ekhara_check_install_runtimeclean"
	@-if test -f $(cmt_local_Ekhara_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_Ekhara_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} Ekhara_check_install_runtimeclean; \
	fi

##	  /bin/rm -f $(cmt_local_Ekhara_check_install_runtime_makefile) $(bin)Ekhara_check_install_runtime_dependencies.make

install :: Ekhara_check_install_runtimeinstall

Ekhara_check_install_runtimeinstall :: $(Ekhara_check_install_runtime_dependencies) $(cmt_local_Ekhara_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install Ekhara_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_Ekhara_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} install
	$(echo) "(constituents.make) install Ekhara_check_install_runtime done"

uninstall :: Ekhara_check_install_runtimeuninstall

Ekhara_check_install_runtimeuninstall :: $(cmt_local_Ekhara_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall Ekhara_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_Ekhara_check_install_runtime_makefile) cmt_lock_pid=$${cmt_lock_pid} uninstall
	$(echo) "(constituents.make) uninstall Ekhara_check_install_runtime done"

ifndef PEDANTIC
.DEFAULT::
	$(echo) "(constituents.make) Starting $@ Ekhara_check_install_runtime"
	$(echo) Using default action for $@
	$(echo) "(constituents.make) $@ Ekhara_check_install_runtime done"
endif
