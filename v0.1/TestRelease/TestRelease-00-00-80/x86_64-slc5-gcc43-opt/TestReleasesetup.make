...
use DatabaseSvc DatabaseSvc-00-00-22 Database (/afs/ihep.ac.cn/bes3/offline/Boss/6.6.4.p01/)
...
use Ekhara Ekhara-00-00-09 Generator (/afs/ihep.ac.cn/bes3/offline/Boss/6.6.4.p01/)
...
use DstEvent DstEvent-00-02-50-patch Event (/afs/ihep.ac.cn/bes3/offline/Boss/6.6.4.p01/)
...
use MucRecEvent MucRecEvent-00-02-50-patch Muc (/afs/ihep.ac.cn/bes3/offline/Boss/6.6.4.p01/)
...
use TrkExtAlg TrkExtAlg-00-00-58-patch-patch Reconstruction (/afs/ihep.ac.cn/bes3/offline/Boss/6.6.4.p01/)
...
use TrkReco TrkReco-00-08-59-patch4 Reconstruction (/afs/ihep.ac.cn/bes3/offline/Boss/6.6.4.p01/)
...
use KalFitAlg KalFitAlg-00-07-55-patch3 Reconstruction (/afs/ihep.ac.cn/bes3/offline/Boss/6.6.4.p01/)
...
suym_no_config (from PROJECT) excludes [suym_config]
suym_root (from PROJECT) excludes [suym_no_root]
suym_cleanup (from PROJECT) excludes [suym_no_cleanup]
suym_no_prototypes (from PROJECT) excludes [suym_prototypes]
suym_with_installarea (from PROJECT) excludes [suym_without_installarea]
suym_with_version_directory (from PROJECT) excludes [suym_without_version_directory]
suym (from PROJECT)
...
----------> CMTPATH
# Add path /besfs/users/suym/6.6.4.p01 from initialization
